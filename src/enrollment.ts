...
- A local job may subscribe to a GitHub definition with \`definition: "github://OWNER/REPOSITORY/PATH?ref=BRANCH_TAG_OR_COMMIT"\`. Preview the resolved commit and capability envelope before publishing. Pinocchio keeps a managed checkout synchronized and blocks source changes that require broader capabilities.
